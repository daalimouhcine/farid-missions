<template>
  <div class="flex gap-x-5">
    <div class="fixed left-0 w-1/12 h-screen bg-blue-200 py-5 z-30" id="right-content">
    ...
    <div
      class="max-sm:w-10/12 max-md:w-9/12 z-auto w-6/12 bg-gray-100 max-md:mr-0 max-md:-translate-x-2 mx-auto -translate-x-[10vw] border-x-[4px] px-5 border-gray-300"
    >
      <CenterScroll />
    </div>
    <div
...
<script setup>
import CenterScroll from "../components/centerContent/CenterScroll.vue";
