<template>
  <div class="w-full h-3/4 mt-auto">
    ...
    <div class="flex flex-col pb-14 h-full overflow-y-scroll hide-scrollbar">
      <div
        class="relative border-4 border-zinc-100 flex gap-x-2 justify-around rounded-md px-5 py-2"
        :class="
          idx !== 0
      ...
      >
        ...
        <div class="flex grow flex-col justify-evenly gap-y-1">
          ...
          <div class="flex items-center gap-x-2">
            ...
            <div class="grow h-1 bg-gray-400">
              <div
                ...
                :style="{
                  width:
                    ((new Date(club.clubDetails.dateStart).getDate() -
                      new Date(club.clubDetails.dateFin).getDate()) /
                      100) *
                      100 +
                    '%',
                }"
